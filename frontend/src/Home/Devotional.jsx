...
function Devotional() {
  ...
  // Ensure blogs is an array before calling filter()
  const devotionalBlogs = Array.isArray(blogs) ? blogs.filter((blog) => blog.category === "Devotion") : [];
  ...
  return (
    <div className="container mx-auto my-12 p-4">
      ...
      {devotionalBlogs.length === 0 ? (
        <div className="text-center text-gray-500">No devotional blogs available.</div>
      ) : (
