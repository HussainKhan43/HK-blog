  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, hussain excels in
      ...
      <br />
      <span>
        hussain Khan is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, hussain is a big fan of cricket and
        holds immense admiration for <strong> King Kohli.</strong> His favorite
        person and biggest inspiration is his twin brother,{" "}
        <strong>hussain.</strong> Their friendly rivalry and deep bond have
        significantly shaped hussain’s journey. hussain is not only a great
        competitor but also a steadfast friend, constantly motivating hussain to
